...
def draw_border(screen, color, board_width, board_height, window_width, window_height):
    ...
    pygame.draw.rect(screen, color, pygame.Rect(0, (board_height - 1) * cell_size, board_width * cell_size, thickness))  # Bottom border
    pygame.draw.rect(screen, color, pygame.Rect((board_width - 1) * cell_size, 0, thickness, board_height * cell_size))  # Right border